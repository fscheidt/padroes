...
class Pessoa(ABC): # ABC == abstract
    # classe abstrata não é usada para criar instancias
...
class PessoaFisica(Pessoa):
    ...
    def __init__(self, nome: str, renda: float, cpf: str):
        super().__init__(nome, renda) # super() - chama o construtor da classe Pessoa
        self.cpf = cpf
...
class PessoaJuridica(Pessoa):
    def __init__(self, nome: str, renda: float, cnpj: str, ie: int):
...
# PessoaFisica.__init__("Maria", 100_000, "100.999.000-99")
